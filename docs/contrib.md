...
See the ``[options.extras_require]`` section in [``setup.cfg``](https://github.com/posita/anydyce/blob/v0.1.0//setup.cfg).
...
* Provide tests where feasible and appropriate.
  ...
  Unit tests live in [``tests``](https://github.com/posita/anydyce/tree/v0.1.0//tests).
