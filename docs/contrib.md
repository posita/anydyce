...
`dyceum` releases from [`main`](https://github.com/posita/anydyce/tree/main) (although not always immediately), so [this workflow](https://githubflow.github.io/#how-we-do-it) might be helpful to understand.
