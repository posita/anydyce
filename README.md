...
[![Version](https://img.shields.io/pypi/v/anydyce/0.1.0.svg)](https://pypi.org/project/anydyce/0.1.0/)
[![Development Stage](https://img.shields.io/pypi/status/anydyce/0.1.0.svg)](https://pypi.org/project/anydyce/0.1.0/)
[![License](https://img.shields.io/pypi/l/anydyce/0.1.0.svg)](http://opensource.org/licenses/MIT)
[![Supported Python Versions](https://img.shields.io/pypi/pyversions/anydyce/0.1.0.svg)](https://pypi.org/project/anydyce/0.1.0/)
[![Supported Python Implementations](https://img.shields.io/pypi/implementation/anydyce/0.1.0.svg)](https://pypi.org/project/anydyce/0.1.0/)
...
[![Binder](https://mybinder.org/badge_logo.svg)](https://mybinder.org/v2/gh/posita/anydyce/v0.1.0?/labpath=docs%2Fnotebooks%2FVisualization%20Examples.ipynb)
...
The [``quickstart-local.sh`` script](https://github.com/posita/anydyce/blob/v0.1.0//quickstart-local.sh) will create a local [virtual environment](https://docs.python.org/3/library/venv.html) to bootstrap a local Jupyter server with ``anydice`` installed and open a web browser to the [examples notebook](https://github.com/posita/anydyce/blob/v0.1.0//docs/notebooks/Visualization%20Examples.ipynb).
...
<picture>
  <source srcset="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_1_dark.png" media="(prefers-color-scheme: dark)">
  <img alt="Plot: Basic plot_burst example" src="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_1_light.png#gh-light-mode-only"><span style="display: none"><img alt="Plot: Taking the lowest or highest die of 2d6" src="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_1_dark.png#gh-dark-mode-only"></span>
</picture>

<details>
<summary>Source: <a href="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_1.py"><code>plot_burst_1.py</code></a></summary>
...
<!-- Should match any title of the corresponding plot title -->
<picture>
  <source srcset="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_2_dark.png" media="(prefers-color-scheme: dark)">
  <img alt="Plot: 2d6 vs. 4dF plot_burst example" src="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_2_light.png#gh-light-mode-only"><span style="display: none"><img alt="Plot: Taking the lowest or highest die of 2d6" src="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_2_dark.png#gh-dark-mode-only"></span>
</picture>

<details>
<summary>Source: <a href="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_2.py"><code>plot_burst_2.py</code></a></summary>
...
<!-- Should match any title of the corresponding plot title -->
<picture>
  <source srcset="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_3_dark.png" media="(prefers-color-scheme: dark)">
  <img alt="Plot: Advanced plot_burst example" src="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_3_light.png#gh-light-mode-only"><span style="display: none"><img alt="Plot: Taking the lowest or highest die of 2d6" src="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_3_dark.png#gh-dark-mode-only"></span>
</picture>

<details>
<summary>Source: <a href="https://raw.githubusercontent.com/posita/anydyce/v0.1.0//docs/assets/plot_burst_3.py"><code>plot_burst_3.py</code></a></summary>
