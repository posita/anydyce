...
![Supported Python Versions](https://img.shields.io/pypi/pyversions/dyceum.svg)
![Supported Python Implementations](https://img.shields.io/pypi/implementation/dyceum.svg)
...
If you find anything lacking in any way, please don’t hesitate to [bring it to my attention](https://dyceum.org/latest/contrib/).
...
* Introduction Jupyter Lite notebook - [http://127.0.0.1:8000/jupyter/lab/?path=dyceum_intro.ipynb](http://127.0.0.1:8000/jupyter/lab/?path=dyceum_intro.ipynb)
* AnyDice-compatible playground - [http://127.0.0.1:8000/playground/](http://127.0.0.1:8000/playground/)

### Requirements

`dyceum` requires a relatively modern version of Python:
...
`dyceum` is proudly 100% [Bear-ified™](https://beartype.rtfd.io/)! 👌🏾🐻
